...
export default function IDEInstructions() {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title">{'Anubis IDE IDEInstructions'}</DialogTitle>
        <DialogContent>
          ...
          <DialogContentText id="alert-dialog-description">
            ...
            To create a new session, go to the assignments tab and click the &quot;Launch Cloud IDE&quot;
            button. You will be taken back to this table while your Cloud IDE instance is being allocated to you.
          </DialogContentText>
          <DialogContentText id="alert-dialog-description">
