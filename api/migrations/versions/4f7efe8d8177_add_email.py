...
fix_lines = [
  ...
  "ALTER TABLE `email_template` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;",
  ...
  "ALTER TABLE `email_template` MODIFY `subject` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL;",
  "ALTER TABLE `email_template` MODIFY `body` varchar(4096) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL;",
  ...
  "ALTER TABLE `email_template` MODIFY `key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL;",
