...
// import analyticsIcon from '../../images/svg/insights.svg';
...
const features = [
  {
    ...
    description:
      'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sed lectus et erat iaculis tempor id ut sem. Proin ultricies consectetur dolor, ',
  },
  {
    name: 'IDEs',
    // icon: ideIcon,
      ...
      {features.map(({ icon, title, description }, index) => (
        <div
          className={`flex flex-col ${
            screen !== 'lg' ? 'col-span-3 p-6' : 'col-span-1'
          } items-start w-full space-y-4`}
        >
