...
const features = [
  {
    ...
    shortDescription:
      'Get quantitative data on how topics and assignments are comprehended',
    icon: insightsIcon,
  },
  {
    name: 'Auto Grader',
  ...
  },
  {
    name: 'Submission',
    shortDescription:
      'Submit assignments as many times as needed getting live feedback as students go',
    icon: submissionIcon,
  },
  {
    name: 'Customizibility',
    shortDescription:
      'Integrate only the parts of Anubis that fit in the curriculum',
    icon: customIcon,
  },
  {
    name: 'Cloud IDE',
    shortDescription:
      "Prebuilt linux IDEs in the cloud tailored to each course's needs",
    icon: ideIcon,
  },
  {
    name: 'Class Management',
    shortDescription:
      "Administrate with Anubis's complete admin panel and Management IDEs",
    icon: manageIcon,
  },
];
        ...
        <div className="w-full grid grid-cols-4 gap-8 pl-6 pr-6">
          {features.map((feature, index) => (
            <motion.li
              ...
              } flex flex-row items-center  space-x-2 bg-light-600 p-4 space-x-4 rounded-lg cursor-pointer`}
              layout
              initial="initial"
              whileHover="hover"
            >
              ...
              <div className="flex flex-col">
                <h1 className="text-lg  font-bold text-light-100">
                  {feature.name}
                </h1>
