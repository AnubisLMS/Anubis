  ...
  return (
    <Layout>
      <div className= 'flex flex-col max-w-5xl w-full items-start justify-center  space-y-24 inline pt-20'>
        <h1 className= 'text-6xl  font-gosha w-full'><span className= 'text-primary'>~</span> Contact</h1>
        <div className= 'w-full bg-light-600 rounded-lg pt-12 pb-12 pr-12 pl-12 space-y-8'>
          <h1 className= 'text-2xl font-bold w-3/4'>Get a behind the scenes look at what we are currently learning, exploring, and creating.</h1>
          <p className= 'text-lg text-light-300'>Reasons why you should reach out: </p>
